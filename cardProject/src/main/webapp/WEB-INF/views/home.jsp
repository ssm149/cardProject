	...
	function View(idxx) {
		...
		function getCheckboxValue()  {
		 ...
		 function checkbox_Check(){
		        if ($("input:checkbox[name=hobby]").is(":checked") == true) {
		                //체크가 되어있을때.    
		        } else {
		                //체크가 안되어있을때.
		        }
...
<input type="hidden" id="userIdx" name="userIdx" value="">
	...
	<div class="user-info-list-pannel">
		...
		<div class="top-header-pannel">
			...
			<div class="function-btn-pannel">
				...
				<button onclick="location.href='/card/' ">
					돌아가기
				</button>
				<button onclick="View(${userIdx}) ">
					삭제
				</button>
		</div>
		...
		<table class="user-info-table2">
			...
			<tbody>
				<tr>
					<td>전화</td>
					<td><input type="tel" maxlength="13" placeholder='   휴대전화 "-" 포함' id="userTelnumWireless"></td>
					<td colspan="2"><input type="tel" maxlength="13" placeholder='   유선 "-" 포함' id="userTelnumWired"></td>
				</tr>
				...
				<tr>
					...
					<td id="test12" style="display: none;">
						<input type="text" id="emailDomain1" name="emailDomain1" />
					</td>
				</tr>
				...
				<table class="edu-table flexibleTable" tb="edu">
					...
					<tbody>
						<tr>
							...
							<td>
								<input type="hidden" data="eduStatus" class="eduStatus">
								<select id="eduStatus" data="eduStatus" class="eduStatus">
									<option value="">선택없음</option>
							...
							<td><input type="text" data="eduEnd" class="eduEnd dateInput"></td>
	...
	<!-- 	<div class="hobby-inventory-table-pannel">
			<table class="hobby-inventory-table flexibleTable" tb="hobby"> -->
		
		
		<div class="hobby-and-qualifi-pannel">
			<div class="hobby-table-pannel">
				<table class="Hobby-table flexibleTable" tb="hobby">
					<thead>
						<tr>
							<td colspan="1">취미</td>
							<td colspan="1">날짜</td>
					...
					<td><textarea data="hobbyName" class="hobbyName"></textarea></td>
					<td><input type="text" data="hobbyDate" class="hobbyDate dateInput"></td>
									
									<!-- <td><input data="hobbyName" type='checkbox' name='hobby'  class="hobbyName" onclick='getCheckboxValue()' value ="a01"/>운동</td>
 									<td><input data="hobbyName" type='checkbox' name='hobby'  class="hobbyName" onclick='getCheckboxValue()' value ="a02"/>독서</td>
 									<td><input data="hobbyName" type='checkbox' name='hobby'  class="hobbyName" onclick='getCheckboxValue()' value ="a03"/>공부</td>
 									<td><input data="hobbyName" type='checkbox' name='hobby'  class="hobbyName" onclick='getCheckboxValue()' value ="a04"/>게임</td>
 									<td><input data="hobbyName" type='checkbox' name='hobby'  class="hobbyName" onclick='getCheckboxValue()' value ="a05"/>기타</td>
									 -->
									<!-- <td><div id='result' type= "hidden"></div></td> -->
	...
	<div class="pop-user-register-pannel" id="drag-ele1">
		...
		<div class="pop-user-search-pannel">
			...
			<select id="userListSearchPeriod">
				...
				<option value="userArmyServ">병역</option>
